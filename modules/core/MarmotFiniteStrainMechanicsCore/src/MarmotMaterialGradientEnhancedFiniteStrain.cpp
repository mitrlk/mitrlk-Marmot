...
void MarmotMaterialGradientEnhancedFiniteStrain::computeStress( ConstitutiveResponse< 3 >&                  response,
...
void MarmotMaterialGradientEnhancedFiniteStrain::computePlaneStress( ConstitutiveResponse< 2 >& response,
