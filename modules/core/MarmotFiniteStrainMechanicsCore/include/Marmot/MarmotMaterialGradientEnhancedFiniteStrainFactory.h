...
namespace MarmotLibrary {
  ...
  public:
    ...
    using materialFactoryFunction = std::function<
      MarmotMaterialGradientEnhancedFiniteStrain*( const double* materialProperties, int nMaterialProperties, int materialNumber ) >;
    ...
    static bool registerMaterial( const std::string& materialName )
    {
      ...
      map[materialName] = []( const double* materialProperties, int nMaterialProperties, int materialNumber )
        -> MarmotMaterialGradientEnhancedFiniteStrain* { return new T( materialProperties, nMaterialProperties, materialNumber ); };
      return true;
    }
